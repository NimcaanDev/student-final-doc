...
import { deleteDocumentFn } from "../../../../redux/slices/documentSlices/deleteDocumentSlice";
import { Bounce, toast, ToastContainer } from "react-toastify";
import { useEffect } from "react";

const DeleteDocumentAlert = ({ document_id }) => {
    const deletedDocumentState = useSelector(state => state.deleteDocument)
    const dispatch = useDispatch()
    const deleteHandler = () => {
        dispatch(deleteDocumentFn(document_id))
    }
    const successToastId = 'success-toast'

    useEffect(() => {
        if (deletedDocumentState?.error) {
            toast.error(deletedDocumentState.error, {
    ...
    }, [deletedDocumentState.data, deletedDocumentState.error]);
