...
import { deleteUserFn } from "../../../../redux/slices/userSlices/deleteUserSlice";

const DeleteUserAlert = ({ user_id }) => {
    ...
    useEffect(() => {
        if (deleteUserState?.error) {
            toast.error(deleteUserState.error, {
        ...
        if (deleteUserState?.data?.isSuccess) {
    ...
    }, [deleteUserState.data, deleteUserState.error]);
